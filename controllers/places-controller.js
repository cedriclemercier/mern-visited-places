...
const getPlaceById = async (req, res, next) => {
  ...
  try {
    ...
    const error = new HttpError('Could not find a place, try again', 500);
    return next(error);
  }
  ...
  // place is an object returned from Mongoose. we need to turn it into a normal JS object
...
const getPlacesByUserId = async (req, res, next) => {
  ...
  try {
    ...
    const error = new HttpError('Cannot find places for the user. Try again', 500);
    return next(error);
  }
